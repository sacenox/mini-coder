...
- Core idea is in [mini-coder-idea.md](mini-coder-idea.md). This file is managed by the user, don't edit unless asked to by the user. Treat this as the source of truth for the design/implementation.
